...
def process_event(cur_row, prev_row):
    ...
    # double
        ...
        if prev_row['Runner1'] == 0 or prev_row['Runner1'] == 1 or prev_row['Runner3'] == 1:
            cur_row.iloc[9:] = update_cols(prev_row, 1, [1 - prob_1sttohome_double, prob_1sttohome_double])
        else:
            cur_row.iloc[9:] = update_cols(prev_row, 1, [1 - prob_2ndto3rd_double, prob_2ndto3rd_double])
